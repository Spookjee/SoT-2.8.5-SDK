...
struct ABP_WarMapVoteSingle_C : AWarMapVoteInteractionActor {
	...
	void UserConstructionScript(); // Function BP_WarMapVoteSingle.BP_WarMapVoteSingle_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x188c2f0
};
