...
struct ABP_Projectile_CannonBall_C : ACannonProjectile {
	...
	void UserConstructionScript(); // Function BP_Projectile_CannonBall.BP_Projectile_CannonBall_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x188c2f0
};
