...
struct Absp_bottle_hanging_light_d_C : AStaticMeshActor {
	...
	void UserConstructionScript(); // Function bsp_bottle_hanging_light_d.bsp_bottle_hanging_light_d_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x188c2f0
};
